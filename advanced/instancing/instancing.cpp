...
int main()
{
    ...
    // -------------------------
    Shader asteroidShader("shaders/asteroids_vertex.glsl", "shaders/asteroids_fragment.glsl");
    ...
    mycamera.Position = glm::vec3(0.0f, 25.0f, 155.0f);
    mycamera.ProcessMouseMovement(0, -11.0f / 0.1f);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < rock.meshes.size(); i++)
        {
            ...
            glDrawElementsInstanced(GL_TRIANGLES, static_cast<unsigned int>(rock.meshes[i].indices.size()), GL_UNSIGNED_INT, 0, display_amount);
            glBindVertexArray(0);
        }
        ...
        ImGui::NewFrame();
        ImGui::Begin("Debug:");
        ImGui::SliderInt("Rocks", &display_amount, 0, amount);
